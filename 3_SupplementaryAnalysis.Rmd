...
KMO = 0.43, exclude sensoryAttenuation_neg (0.33)

```{r KMO implicit 2}
#update correlation matrix without excluded variable
correlation_implicit_1 <- correlation_implicit[!rownames(correlation_implicit) == "sensoryAttenuation_neg",
                                              !colnames(correlation_implicit) == "sensoryAttenuation_neg"]

#define correlation matrix for later analysis
cur_correlation_implicit <- correlation_implicit_1
...
KMO = 0.48, exclude reaching_head (0.39)

```{r KMO implicit 3}
#update correlation matrix without excluded variable
correlation_implicit_2 <- correlation_implicit_1[!rownames(correlation_implicit_1) == "reaching_head",
                                               !colnames(correlation_implicit_1) == "reaching_head"]

#define correlation matrix for later analysis
cur_correlation_implicit <- correlation_implicit_2
...
exclude reaching_arm (0.44)

```{r KMO implicit 4}
#update correlation matrix without excluded variable
correlation_implicit_3 <- correlation_implicit_2[!rownames(correlation_implicit_2) == "reaching_arm",
                                               !colnames(correlation_implicit_2) == "reaching_arm"]

#define correlation matrix for later analysis
cur_correlation_implicit <- correlation_implicit_3
...
KMO(cur_correlation_implicit)
```
KMO = 0.53, but variables with KMO <.5, exclude temporalContingency_left (0.44)

```{r KMO implicit 5}
#update correlation matrix without excluded variable
correlation_implicit_4 <- correlation_implicit_3[!rownames(correlation_implicit_3) == "temporalContingency_left",
                                               !colnames(correlation_implicit_3) == "temporalContingency_left"]

#define correlation matrix for later analysis
cur_correlation_implicit <- correlation_implicit_4
...
KMO(cur_correlation_implicit)
```
KMO = 0.6 % all variables with KMO >= 0.5 -> proceed
...
however, when proceeding from here, parallel analysis suggests 4 factors and EFA produces Heywood cases
therefore now excluding variable with smallest KMO until all variables have KMO >= 0.5
-> exclude bodyObstacle_errorFree (0.33)

```{r KMO explicit 2}
#update correlation matrix without excluded variable
correlation_explicit_1 <- correlation_explicit[!rownames(correlation_explicit) == "bodyObstacle_errorFree",
                                              !colnames(correlation_explicit) == "bodyObstacle_errorFree"]

#define correlation matrix for later analysis
cur_correlation_explicit <- correlation_explicit_1
...
KMO = 0.55, but still one variable <.5 -> excluding bodySizeToys_errorFree (0.39)

```{r KMO explicit 3}
#update correlation matrix without excluded variable
correlation_explicit_2 <- correlation_explicit_1[!rownames(correlation_explicit_1) == "bodySizeToys_errorFree",
                                              !colnames(correlation_explicit_1) == "bodySizeToys_errorFree"]

#define correlation matrix for later analysis
cur_correlation_explicit <- correlation_explicit_2
...
-> however, videoSelfRecognition also loads with .37, so loading this onto 2nd factor, too

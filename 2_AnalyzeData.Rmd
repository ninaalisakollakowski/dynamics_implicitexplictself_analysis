...
## define factor variables back to numeric
otherwise correlation function won't work
```{r}
currentData[dichotomousVariables] <- lapply(currentData[dichotomousVariables], numeric)
```

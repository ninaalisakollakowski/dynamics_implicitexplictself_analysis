...
as EFA exceeds maximum iteration, trying to exclude all variables with KMO <.5 iteratively
```{r KMO}
<<<<<<< HEAD
KMO(correlation_implicit) #KMO = 0.5 overall but several variables <.5 -> exclude reaching_head (0.44)
correlation_implicit1 <- correlation_implicit[!rownames(correlation_implicit) == "reaching_head",
                                              !colnames(correlation_implicit) == "reaching_head"]
excludedVariables_implicit_KMO <- list("reaching_head")
excludedVariables_implicit <- list("reaching_head")

#run KMO again
KMO(correlation_implicit1) #KMO = 0.54 overall but several variables <.5 -> exclude temporalContingency_left (0.49)
correlation_implicit2 <- correlation_implicit1[!rownames(correlation_implicit1) == "temporalContingency_left",
                                              !colnames(correlation_implicit1) == "temporalContingency_left"]
...
KMO(correlation_implicit2) #KMO = 0.56 overall, all variables over >.5 -> proceed
=======
...
#run KMO again
KMO(correlation_implicit1) #KMO = 0.51 -> exclude reaching_head (0.43)
...
KMO(correlation_implicit2) #KMO = 0.55, exclude sensoryAttenuation_neg (0.42)
correlation_implicit3 <- correlation_implicit2[!rownames(correlation_implicit2) == "sensoryAttenuation_neg",
                                              !colnames(correlation_implicit2) == "sensoryAttenuation_neg"]
excludedVariables_implicit_KMO <- append(excludedVariables_implicit_KMO, "sensoryAttenuation_neg")
excludedVariables_implicit <- append(excludedVariables_implicit, "sensoryAttenuation_neg")

KMO(correlation_implicit3) #KMO = 0.59, all variables > 0.5

cur_correlation_implicit <- correlation_implicit3
>>>>>>> f206ce73ff7f29e36ac3fe114c849a8a9cee5f98
```
...
```{r parallel analysis}
<<<<<<< HEAD
fa.parallel(correlation_implicit2, n.obs = nObservations, n.iter = 1000, fm = "ml", fa = "fa")
```
...
<<<<<<< HEAD
efa.implicit <- fa(correlation_implicit2, nfactors = 2, n.obs = nObservations, 
...
```{r KMO}
<<<<<<< HEAD
KMO(correlation_explicit) #KMO = 0.51 but several variables below .5 -> exclude bodySizeToys_errorFree (0.33)
correlation_explicit1 <- correlation_explicit[!rownames(correlation_explicit) == "bodySizeToys_errorFree",
                                              !colnames(correlation_explicit) == "bodySizeToys_errorFree"]
excludedVariables_explicit_KMO <- list("bodySizeToys_errorFree")
excludedVariables_explicit <- list("bodySizeToys_errorFree")

KMO(correlation_explicit1) #overall KMO = 0.61, but variables below .5 -> exclude bodyObstacle_errorFree (0.49)
correlation_explicit2 <- correlation_explicit1[!rownames(correlation_explicit1) == "bodyObstacle_errorFree",
                                              !colnames(correlation_explicit1) == "bodyObstacle_errorFree"]
excludedVariables_explicit_KMO <- append(excludedVariables_explicit_KMO, "bodyObstacle_errorFree")
excludedVariables_explicit <- append(excludedVariables_explicit, "bodyObstacle_errorFree")

KMO(correlation_explicit2) #overall KMO = 0.63 & all variables <.5 -> proceed
=======
...
```{r parallel analysis}
<<<<<<< HEAD
fa.parallel(correlation_explicit2, n.obs = nObservations, n.iter = 1000, fm = "ml", fa = "fa")
```
parallel analysis suggests 2 factors  
=======
...
#run EFA with 3 factors as suggested by parallel analysis
<<<<<<< HEAD
efa.explicit <- fa(correlation_explicit2, nfactors = 2, n.obs = nObservations, 
                   rotate = 'oblimin', fm = 'pa')
=======

...
spatialContingencyData <- Result %>%
  ...
  mutate(legMovementScore_corrected = ifelse(is.na(legMovementScore), 0.5, legMovementScore)) %>%
...
```{r}
library(dplyr)
languageData_buffer <- readxl::read_excel("Z:/Längsschnitt Selbst/Auswertung/T4/Fragebögen/FRAKIS-K/FRAKIS-AUSWERTUNG.xlsx")
